    ...
    <div class="max-w-2xl mx-auto">
        <div class="card">
            <div class="card-header">
                ...
                <p class="text-sm text-gray-600">Fill in the details for the new package</p>
            </div>
            <div class="card-body">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div class="md:col-span-2">
                            ...
                            <textarea name="features" id="features" rows="4" 
                                      ...
                                      class="w-full border-gray-300 rounded-md shadow-sm focus:ring-blue-500 focus:border-blue-500 @error('features') border-red-300 @enderror">{{ old('features') }}</textarea>
                            @error('features')
                                <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                            @enderror
                        </div>
