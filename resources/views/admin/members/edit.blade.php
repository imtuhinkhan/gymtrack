...
<div class="container mx-auto px-4 py-6">
    <div class="flex justify-between items-center mb-6">
        <h1 class="text-3xl font-bold text-gray-800">Edit Member: {{ $member->first_name }} {{ $member->last_name }}</h1>
    ...
    <div class="max-w-2xl mx-auto">
        <div class="card">
            <div class="card-header">
                ...
                <p class="text-sm text-gray-600">Update the member details</p>
            </div>
            <div class="card-body">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div>
                            ...
                            <select name="package_id" id="package_id" 
                                ...
                                @foreach($packages as $package)
                                    @php
                                        $currentPackage = $member->subscriptions()->where('status', 'active')->first()?->package_id;
                                    @endphp
                                    <option value="{{ $package->id }}" {{ old('package_id', $currentPackage) == $package->id ? 'selected' : '' }}>
                        ...
                        <div class="md:col-span-2">
                            ...
                            <textarea name="address" id="address" rows="3" 
                                      class="w-full border-gray-300 rounded-md shadow-sm focus:ring-blue-500 focus:border-blue-500 @error('address') border-red-300 @enderror">{{ old('address', $member->address) }}</textarea>
                            @error('address')
                                <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                            @enderror
                        </div>
                        ...
                        <div>
                            ...
                            <textarea name="medical_conditions" id="medical_conditions" rows="3" 
                                      class="w-full border-gray-300 rounded-md shadow-sm focus:ring-blue-500 focus:border-blue-500 @error('medical_conditions') border-red-300 @enderror">{{ old('medical_conditions', $member->medical_conditions) }}</textarea>
                        ...
                        <div>
                            ...
                            <textarea name="allergies" id="allergies" rows="3" 
                                      class="w-full border-gray-300 rounded-md shadow-sm focus:ring-blue-500 focus:border-blue-500 @error('allergies') border-red-300 @enderror">{{ old('allergies', $member->allergies) }}</textarea>
                            @error('allergies')
                                <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                            @enderror
                        </div>
                        ...
                        <div class="md:col-span-2">
                            ...
                            @if($member->profile_image)
                                <div class="mb-4">
                                    ...
                                    <img src="{{ asset('storage/' . $member->profile_image) }}" alt="Current Profile Photo" class="h-32 w-32 object-cover rounded-lg">
                                </div>
                            @endif
                                ...
                                <div class="space-y-1 text-center">
                                    ...
                                    <div class="flex text-sm text-gray-600">
                                        <label for="profile_image" class="relative cursor-pointer bg-white rounded-md font-medium text-blue-600 hover:text-blue-500 focus-within:outline-none focus-within:ring-2 focus-within:ring-offset-2 focus-within:ring-blue-500">
                                            <span>{{ $member->profile_image ? 'Change photo' : 'Upload a photo' }}</span>
