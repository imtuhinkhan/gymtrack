...
<div class="space-y-6">
    ...
    <div class="flex justify-between items-center mb-6">
        <div>
            <h1 class="text-3xl font-bold text-gray-800">Create Permission</h1>
            <p class="text-gray-600">Create a new permission for the system</p>
        </div>
                ...
                <form method="POST" action="{{ route('admin.permissions.store') }}">
                    ...
                    <div class="mb-6">
                        ...
                        <textarea name="description" id="description" rows="3"
                                  ...
                                  placeholder="Enter a description for this permission">{{ old('description') }}</textarea>
                        @error('description')
                            <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                        @enderror
