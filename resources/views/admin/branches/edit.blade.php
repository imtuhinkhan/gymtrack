...
<div class="container mx-auto px-4 py-6">
    <div class="flex justify-between items-center mb-6">
        <h1 class="text-3xl font-bold text-gray-800">Edit Branch: {{ $branch->name }}</h1>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div class="md:col-span-2">
                        ...
                        <input type="text" id="name" name="name" value="{{ old('name', $branch->name) }}" required
                               class="form-input mt-1 block w-full @error('name') border-red-500 @enderror">
                        @error('name')
                    ...
                    <div class="md:col-span-2">
                        ...
                        <textarea id="description" name="description" rows="3"
                                  class="form-input mt-1 block w-full @error('description') border-red-500 @enderror">{{ old('description', $branch->description) }}</textarea>
                        @error('description')
                            <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                        @enderror
                    </div>
                    ...
                    <div>
                        ...
                        <input type="email" id="email" name="email" value="{{ old('email', $branch->email) }}" required
                               class="form-input mt-1 block w-full @error('email') border-red-500 @enderror">
                        @error('email')
                            <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                        @enderror
                    </div>
                    ...
                    <div>
                        ...
                        <input type="text" id="phone" name="phone" value="{{ old('phone', $branch->phone) }}" required
                    ...
                    <div class="md:col-span-2">
                        ...
                        <input type="text" id="address" name="address" value="{{ old('address', $branch->address) }}" required
                    ...
                    <div>
                        ...
                        <input type="text" id="state" name="state" value="{{ old('state', $branch->state) }}" required
                    ...
                    <div>
                        ...
                        <input type="text" id="postal_code" name="postal_code" value="{{ old('postal_code', $branch->postal_code) }}" required
                    ...
                    <div>
                        ...
                        <input type="text" id="country" name="country" value="{{ old('country', $branch->country) }}" required
                    ...
                    <div>
                        ...
                        <input type="email" id="manager_email" name="manager_email" value="{{ old('manager_email', $branch->manager_email) }}"
                    ...
                    <div>
                        ...
                        <input type="text" id="manager_phone" name="manager_phone" value="{{ old('manager_phone', $branch->manager_phone) }}"
                    ...
                    <div>
                        ...
                        <input type="time" id="opening_time" name="opening_time" value="{{ old('opening_time', $branch->opening_time) }}" required
                    ...
                    <div>
                        ...
                        <input type="time" id="closing_time" name="closing_time" value="{{ old('closing_time', $branch->closing_time) }}" required
                    ...
                    <div class="md:col-span-2">
                        ...
                        <div class="mt-2 grid grid-cols-7 gap-2">
                            @php
                                $workingDays = old('working_days', is_string($branch->working_days) ? json_decode($branch->working_days, true) : ($branch->working_days ?? []));
                            @endphp
                    ...
                    <div>
                        ...
                        @if($branch->logo)
                            <p class="mt-1 text-sm text-gray-500">Current: <a href="{{ Storage::url($branch->logo) }}" target="_blank" class="text-blue-600">View Logo</a></p>
                        @endif
                        @error('logo')
                            <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                        @enderror
                    ...
                    <div>
                        ...
                        @if($branch->banner)
                            <p class="mt-1 text-sm text-gray-500">Current: <a href="{{ Storage::url($branch->banner) }}" target="_blank" class="text-blue-600">View Banner</a></p>
                        @endif
                        @error('banner')
                            <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                        @enderror
