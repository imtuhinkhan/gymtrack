...
<div class="container mx-auto px-4 py-6">
    <div class="flex justify-between items-center mb-6">
        <h1 class="text-3xl font-bold text-gray-800">Create New Trainer</h1>
    ...
    <div class="max-w-2xl mx-auto">
        <div class="card">
            <div class="card-header">
                ...
                <p class="text-sm text-gray-600">Fill in the details for the new trainer</p>
                <div class="mt-2 p-3 bg-blue-50 border border-blue-200 rounded-lg">
                    <div class="flex">
                        ...
                        <div>
                            ...
                            <p class="text-xs text-blue-700">A user account will be automatically created for this trainer with the provided email and default password: <strong>password123</strong></p>
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div class="md:col-span-2">
                            ...
                            <textarea name="specializations" id="specializations" rows="3" 
                                      ...
                                      class="w-full border-gray-300 rounded-md shadow-sm focus:ring-blue-500 focus:border-blue-500 @error('specializations') border-red-300 @enderror">{{ old('specializations') }}</textarea>
