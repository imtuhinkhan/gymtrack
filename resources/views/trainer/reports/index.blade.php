...
<div class="space-y-6">
    ...
    <div class="card mb-6">
        <div class="card-body">
            <form method="GET" action="{{ route('trainer.reports.index') }}" class="flex items-end space-x-4">
                <div class="flex-1">
                ...
                <div class="flex items-end">
                    ...
                    <a href="{{ route('trainer.reports.index') }}" class="btn btn-outline ml-2">
                        <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <div class="stats-card">
            <div class="stats-card-header">
                <div class="flex items-center">
                    ...
                    <div class="ml-5 w-0 flex-1">
                        <dl>
                            <dt class="stats-card-title">Active Members</dt>
                            <dd class="stats-card-value">{{ $stats['active_members'] }}</dd>
                        </dl>
                    </div>
                </div>
            </div>
    ...
    <!-- Recent Workout Routines -->
    <div class="card">
        <div class="card-header">
            <h3 class="text-lg font-medium text-gray-900">Recent Workout Routines</h3>
        </div>
        <div class="card-body">
            ...
            @else
                <div class="text-center py-8">
                    ...
                    <p class="mt-1 text-sm text-gray-500">No workout routines found for your members.</p>
                </div>
            @endif
        </div>
    </div>
